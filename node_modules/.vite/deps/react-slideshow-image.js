...
var FadeZoom = import_react.default.forwardRef(function(props, ref) {
  var _useState = (0, import_react.useState)(getStartingIndex(props.children, props.defaultIndex)), index = _useState[0], setIndex = _useState[1];
  ...
  var play = (0, import_react.useCallback)(function() {
    ...
    if (autoplay && import_react.default.Children.count(children) > 1 && (infinite || index < import_react.default.Children.count(children) - 1)) {
  ...
  (0, import_react.useImperativeHandle)(ref, function() {
    return {
      ...
      goTo: function goTo(index2, options) {
  ...
  var moveNext = function moveNext2() {
    ...
    if (!infinite && index === import_react.default.Children.count(children) - 1) {
      return;
    }
    transitionSlide((index + 1) % import_react.default.Children.count(children));
  };
  var moveBack = function moveBack2() {
    ...
    transitionSlide(index === 0 ? import_react.default.Children.count(children) - 1 : index - 1);
  };
  ...
  var transitionSlide = function transitionSlide2(newIndex) {
    ...
    if (!existingTweens.length) {
      ...
      var tween = new Tween(value, tweenGroup.current).to({
        ...
        innerWrapperRef.current.children[index].style.opacity = 1 - value2.opacity;
        innerWrapperRef.current.children[index].style.transform = "scale(" + value2.scale + ")";
      });
  ...
  }, props.arrows && showPreviousArrow(props, index, preTransition), import_react.default.createElement("div", {
...
var Slide = import_react.default.forwardRef(function(props, ref) {
  ...
  var moveTo = function moveTo2(index2) {
    transitionSlide(calculateIndex(index2));
  };
  ...
  var renderPreceedingSlides = function renderPreceedingSlides2() {
    return import_react.default.Children.toArray(props.children).slice(-slidesToShow).map(function(each, index2) {
      return import_react.default.createElement("div", {
        "data-index": index2 - slidesToShow,
        "aria-roledescription": "slide",
        "aria-hidden": "true",
        key: index2 - slidesToShow
      }, each);
    });
  };
  var renderTrailingSlides = function renderTrailingSlides2() {
    ...
    return import_react.default.Children.toArray(props.children).slice(0, slidesToShow).map(function(each, index2) {
      return import_react.default.createElement("div", {
        "data-index": childrenCount + index2,
        "aria-roledescription": "slide",
        "aria-hidden": "true",
  ...
  return import_react.default.createElement("div", {
    ...
    onTouchMove: swipe
  }, props.arrows && showPreviousArrow(props, index, moveSlides), import_react.default.createElement("div", {
